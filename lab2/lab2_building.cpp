...
struct Building {
	...
	GLfloat vertex_buffer_data[72] = {  // Vertex definition for a box on the XZ plane
		// Front face
		-1.0f, 0.0f, 1.0f,
		 1.0f, 0.0f, 1.0f,
		 1.0f, 2.0f, 1.0f,
...
int main(void)
{
	...
	texture_paths.push_back("../lab2/facade1.jpg");
	texture_paths.push_back("../lab2/facade2.jpg");
	texture_paths.push_back("../lab2/facade3.jpg");
	texture_paths.push_back("../lab2/facade4.jpg");
    texture_paths.push_back("../lab2/facade5.jpg");
